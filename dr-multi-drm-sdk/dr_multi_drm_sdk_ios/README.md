...
[![pub package](https://img.shields.io/badge/pub-1.2.5-orange)](https://pub.dev/packages/dr_multi_drm_sdk_ios)
...
On iOS, the [dr_multi_drm_sdk][1] plugin has been available since version 1.2.0, and we always recommend using the latest version (>=1.2.5).
